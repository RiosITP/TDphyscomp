---
title: OSC with arduino to TD
layout: home
nav_order: 2
parent: Wifi Examples
---

# Sending Arduino Values to TouchDesigner via OSC over WiFi

The following write up will show how to combine sample code from various sources to send multiple sensor values from the [Arduino Nano 33 IoT](https://store-usa.arduino.cc/products/arduino-nano-33-iot) to be read and interpreted in [TouchDesigner](https://derivative.ca/)
...
* [OSC Library](https://www.arduino.cc/reference/en/libraries/osc/)
* WiFi access
...
![TouchDesigner network with udpin DAT highlighted, showing port and local IP fields populated](/imgs/convert.png)
